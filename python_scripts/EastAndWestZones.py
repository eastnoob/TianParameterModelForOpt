...
#    extension_factor = length
    ...
    left_zone = rg.Curve.JoinCurves([left_up_cup, left_down_cup, left_start_cup, left_end_cup])[0]
    right_zone = rg.Curve.JoinCurves([right_up_cup, right_down_cup, right_start_cup, right_end_cup])[0]
